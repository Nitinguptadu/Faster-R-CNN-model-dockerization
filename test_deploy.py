...
#    test_base_path = '/home/nitin/Desktop/Faster_RCNN-x ray/Dataset/Open Images Dataset v4 (Bounding Boxes)/test/0000a175-0e68-4ca4-b1af-167204a7e0bc.jpg' # Directory to save the test images
    ...
    #CUSTOM CODE
    model_path_custom = "/usr/src/app/model/model_frcnn_vgg.hdf5"
    ...
    for idx, img_name in enumerate(imgs_path):
        ...
        #plt.show()
        plt.imsave('/usr/src/app/uploads/test.png', img)
        ...
        plt.imsave('/usr/src/app/prediction/'+image_name +'.png', img)



        im_path = "/usr/src/app/uploads/"
        im_name = "test.png"
